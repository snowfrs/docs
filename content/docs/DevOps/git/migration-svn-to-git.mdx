---
title: "Migration SVN to Git"
icon: GitBranch
tags: SVN Git
---

最近需要考虑将某些项目从 SVN 迁移到 Git.

Atlassian有篇非常优秀的[文章][migrating-to-git]介绍如何从SVN迁移到Git; 如果你准备迁移到Gitlab, 那么Gitlab官方也有一篇[文章][migrating-to-gitlab]介绍如何操作.
...
添加`remote origin`之前, 我们先做一些本地配置
