---
icon: Database
title: "Managing ACLs via the ONTAP Command Line"
---
icon: Database
# Managing ACLs via the ONTAP Command Line
## Contents

* 1 Viewing permissions in multiprotocol NAS
* 2 Translating NTFS style DACLs
* 3 Expanding ACLs
* 4 Applying ACLs to objects from the storage
...
![Unix-windows-acl1](/assets/images/Unix-windows-acl1.png)
...
![Unix-windows-acl2](/assets/images/Unix-windows-acl2.png)
...
![Unix-windows-acl3](/assets/images/Unix-windows-acl3.png)
...
In the above ACL, we see 0x1f01ff for Everyone. That's Full Control. In addition, 0x10000000 is considered GENERIC\_ALL.
...
https://whyistheinternetbroken.wordpress.com/2017/02/01/managing-acls-ontap-cli/
