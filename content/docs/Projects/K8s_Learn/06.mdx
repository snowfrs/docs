...
### 6.1 Seccomp (Secure Computing Mode)
...
graph LR
    subgraph "CI Stage"
        Code[Code Commit] --> Build[Docker Build]
    ...
    subgraph "CD Stage"
        ...
        Deploy --> Adm[Kyverno Admission]
        Adm -- "Verify Signature" --> V{Valid?}
        V -- "Yes" --> Run[Pod Running]
        V -- "No" --> Block[Admission Denied]
    end
```
...
### 10.1 Lab 1: 配置 Pod Security Standards
...
### 10.3 Lab 3: 编写 AppArmor Profile
