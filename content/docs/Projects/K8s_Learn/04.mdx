...
## 6. 核心架构: CSI (Container Storage Interface)
...
## 9. 本地存储: Local Persistent Volume
...
### 9.3 使用 local-static-provisioner 自动化
...
### 11.2 Lab 2: VolumeSnapshot 备份与恢复
...
### 11.3 Lab 3: 存储加密 (Encryption at Rest)
