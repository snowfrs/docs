...
* 英文文档：[http://vimdoc.sourceforge.net/htmldoc/](http://vimdoc.sourceforge.net/htmldoc/)
* 中文文档：[http://vimcdoc.sourceforge.net/doc/](http://vimcdoc.sourceforge.net/doc/)
...
`RUNTIMEPATH` 变量可通过 `:set rtp` 打印出来，详情请参考：[http://vimcdoc.sourceforge.net/doc/options.html#'runtimepath'](http://vimcdoc.sourceforge.net/doc/options.html#'runtimepath')
...
参考：[http://vimcdoc.sourceforge.net/doc/filetype.html#filetype-plugins](http://vimcdoc.sourceforge.net/doc/filetype.html#filetype-plugins)
